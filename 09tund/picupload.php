<?php
    ...
    //echo "teadmata: " .$myTest->secretNumber; //private, kätte ei saa
    //$myTest->multiplyNumbers();
    //unset($myTest);
    //echo " teada: " .$myTest->knownNumber; //ei saa, kuna klass on lõpetatud
    ...
    if(isset($_POST["submitPic"])) {
        ...
        // if everything is ok, try to upload file
            ...
            if($picW > $maxPicW or $picH > $maxPicH){
                ...
                $myNewImage = setPicSize($myTempImage, $picSizeRatio);*/ //- viidud klassi üle
